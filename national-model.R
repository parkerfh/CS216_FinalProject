...
full <- multinom(as.factor(abortion_status) ~ fp_perc_need_met16 + fp_num_served16 + fp_num_u20_served16 + fp_num_centers15 
            + fp_total_expend15 + STATEFP20 + ad_num_waiting16 + ad_num_adopted16+ad_num_served16+
...
best_model <- multinom(as.factor(abortion_status) ~ ad_num_waiting16*ad_num_adopted16 + ad_num_adopted16*ad_num_served16
                       + prop_uninsured16 + ad_prop_adopted16 + STATEFP20 + fp_num_served16*fp_num_u20_served16
                       + fp_total_expend15 + parental_leave_score + fp_perc_need_met16 + fp_num_centers15, data = data)
...
table(data$abortion_status, pred)
